...
export default function ChannelList({channels, onChannelLoaded, selectedGroupName, onBackClick}: Props) {
                        ...
                        {pageItems.map((ch, i) => (
                            ...
                            >
                                ...
                                <Box sx={{ flex: 1, minWidth: 0 }}>
                                    ...
                                    }} variant="caption" color="text.secondary" noWrap  title={ch.url}>{ch.url}</Typography>
                                </Box>
